...
# textos para direcionar
# peso
ttk.Label(input_frame, text='PESO').grid(row=2, column=0, padx=(0,10), pady=5, sticky='e')

entry_peso = ttk.Entry(input_frame, width=30)
entry_peso.grid(row=2, column=1, padx=(0,20), pady=5, sticky='w')


# textos para direcionar
# altura
ttk.Label(input_frame, text='ALTURA').grid(row=2, column=0, padx=(0,10), pady=5, sticky='e')

entry_latura = ttk.Entry(input_frame, width=30)
entry_altura.grid(row=2, column=1, padx=(0,20), pady=5, sticky='w')
